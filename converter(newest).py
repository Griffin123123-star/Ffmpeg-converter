...
if my_subtitle and not HardSubtitleAnswer:
...
valid_audio_codec=['aac', 'mp3', 'ac3', 'eac3', 'opus', 'flac', 'copy']
print("Please enter one of the following: " + ', '.join(valid_audio_codec))

while True:
    audio_codec=input("Enter your audio codec, or enter 'copy' to copy").lower()
    if audio_codec.lower() in valid_audio_codec:
        break
    else:
        print("Invalid codec! Please enter one of the following: " + ', '.join(valid_audio_codec))

valid_video_codec=['libx264', 'libx265', 'mpeg4', 'vp9', 'copy']
print("Please enter one of the following: " + ', '.join(valid_video_codec))

while True:
    video_codec=input("Enter your video codec, or enter 'copy' to copy").lower()
...
if vf_filters and video_codec != 'copy':
    ffmpeg_command += ['-vf', ','.join(vf_filters)]
    
if Map3 and not HardSubtitle:
